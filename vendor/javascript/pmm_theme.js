...
const pmmtheme = { 
    ...
    functions: { 
        ...
        searchitem(item) { 
            ...
            // search for li contains the input value 
            ...
            if (noResults) { 
                if (parent.querySelectorAll('li[style="display: none;"]').length == items.length) { 
...
// declare pmmtheme as global variable 
window.pmmtheme = pmmtheme; 
console.log(window.pmmtheme); 
// export as module 
// export default pmmtheme; 
 
// Webpack support 
if (typeof module !== 'undefined') { 
    module.exports = pmmtheme; 
} 
